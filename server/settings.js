...
export const SETTINGS_SCHEMA = [
  ...
  { key: 'step_streaming', group: 'Execution', label: 'Step-level streaming', type: 'enum', options: ['on', 'off'], env: 'STEP_STREAMING', default: 'on', editableLive: true, description: 'SSH dispatch uses --output-format stream-json: every tool call becomes a live timeline step (Run Theater) and is persisted on the trace. off = single end-of-run JSON blob.' },
